...
public class PartmentMonthStat {
	...
	/*每天的统计*/
	private List<PartmentDayStat> pdsList = new ArrayList<PartmentDayStat>() ;
	
	
	public PartmentMonthStat(){
		
	}
	
	public PartmentMonthStat(TbPartment tbPartment) {
	...
	public List<PartmentDayStat> getPdsList() {
		return pdsList;
	}

	public void setPdsList(List<PartmentDayStat> pdsList) {
