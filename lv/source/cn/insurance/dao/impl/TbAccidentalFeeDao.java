...
public class TbAccidentalFeeDao extends BaseDao implements ITbAccidentalFeeDao {

	/**
	 * 返回一个对象结果集
	 */
	@Override
	public Object mapObj(ResultSet rs) throws SQLException {
	...
	public TbAccidentalFee getAccidentFeeByPartmentId(Integer partmentId) {
		String sql = "SELECT * FROM tbAccidentalFee WHERE intPartmentId="  + partmentId+" AND dbeMoneyTypeID=10";
	...
	public TbAccidentalFee getObjectInfoById(Integer id) {
		String sql = "SELECT * FROM tbAccidentalFee WHERE id=" + id+" AND dbeMoneyTypeID=10";
		return (TbAccidentalFee)super.query(sql);
	}
	...
	public int deleteByPartmentId(Integer partmentId){
		String sql = "DELETE FROM tbAccidentalFee intPartmentId="+partmentId+" AND dbeMondyTypeID=10";
