...
public class TbAccidentalFeeDaoS extends BaseDao implements ITbAccidentalFeeDaoS {
	...
	public TbAccidentalFee getAccidentFeeByPartmentId(Integer partmentId) {
		String sql = "SELECT * FROM tbAccidentalFee WHERE intPartmentId="  + partmentId+" AND dbeMoneyTypeID=30";
	...
	public TbAccidentalFee getObjectInfoById(Integer id) {
		String sql = "SELECT * FROM tbAccidentalFee WHERE id=" + id+" AND dbeMoneyTypeID=30";
	...
	public int deleteByPartmentId(Integer partmentId){
		String sql = "DELETE FROM tbAccidentalFee intPartmentId="+partmentId+" AND dbeMondyTypeID=30";
