...
import cn.insurance.dao.ITbAccidentalFee_CarDaoT;
 ...
 *
 */
public class PirceServT implements IPriceServT {
	
	private ITbAccidentalFeeDaoT tbAccidentalFeeDaoT ;
	
	private ITbAdjustFeeDao tbAdjustFeeDao ;
	
	private ITbPartmentDao tbPartmentDao ;
	
	private ITbAccidentalFee_CarDaoT tbAccidentalFee_CarDaoT;
	...
	public TbAccidentalFee getNormalAccidentalFee() {
		/*默认设定意外险通用价格的ID为1*/
		return tbAccidentalFeeDaoT.getObjectInfoById(1);
	}
	...
	public TbAccidentalFee getCompanyAccdFeeById(Integer companyId) {
		...
		return tbAccidentalFeeDaoT.getAccidentFeeByPartmentId(companyId) ;
	}
	...
	public int updateNormalAccidentalFee(TbAccidentalFee tbAccidentalFee){
		tbAccidentalFeeDaoT.updateNormalAccidentalFee(tbAccidentalFee) ;
		return 1 ;
	}
	...
	private TbBill setAccidentalPrice(TbBill tbBill ,Integer companyId){
		/*查询意外先价格设定*/
		TbAccidentalFee tbAccidentalFee = tbAccidentalFeeDaoT.getAccidentFeeByPartmentId(companyId) ;
...
//		}
	...
	public ITbAccidentalFeeDaoT getTbAccidentalFeeDaoT() {
		return tbAccidentalFeeDaoT;
	}

	public void setTbAccidentalFeeDaoT(ITbAccidentalFeeDaoT tbAccidentalFeeDaoT) {
		this.tbAccidentalFeeDaoT = tbAccidentalFeeDaoT;
	}
	...
	public ITbAccidentalFee_CarDaoT getTbAccidentalFee_CarDaoT() {
		return tbAccidentalFee_CarDaoT;
	}

	public void setTbAccidentalFee_CarDaoT(
			ITbAccidentalFee_CarDaoT tbAccidentalFeeCarDaoT) {
		tbAccidentalFee_CarDaoT = tbAccidentalFeeCarDaoT;
	}
