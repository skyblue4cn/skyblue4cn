...
import cn.insurance.dao.ITbAccidentalFeeDaoS;
...
import cn.insurance.service.IPriceServT;
import cn.insurance.service.IPriceServS;
 ...
 *
 */
public class PirceServS implements IPriceServS {
	
	private ITbAccidentalFeeDaoS tbAccidentalFeeDaoS ;
	
	private ITbAdjustFeeDao tbAdjustFeeDao ;
	
	private ITbPartmentDao tbPartmentDao ;

	private ITbAccidentalFee_CarDaoS tbAccidentalFee_CarDaoS;
	...
	public TbAccidentalFee getNormalAccidentalFee() {
		/*默认设定意外险通用价格的ID为1*/
		return tbAccidentalFeeDaoS.getObjectInfoById(3);
	}
	...
	public TbAdjustFee getNormalAdjustFee(){
		return (TbAdjustFee)tbAdjustFeeDao.getObjectInfoById(3) ;
	}
	...
	public TbAccidentalFee getCompanyAccdFeeById(Integer companyId) {
		...
		return tbAccidentalFeeDaoS.getAccidentFeeByPartmentId(companyId) ;
	}
	...
	public int updateNormalAccidentalFee(TbAccidentalFee tbAccidentalFee){
		tbAccidentalFeeDaoS.updateNormalAccidentalFee(tbAccidentalFee) ;
		return 1 ;
	}
	...
	private TbBill setAccidentalPrice(TbBill tbBill ,Integer companyId){
		/*查询意外先价格设定*/
		TbAccidentalFee tbAccidentalFee = tbAccidentalFeeDaoS.getAccidentFeeByPartmentId(companyId) ;
...
//		}
	...
	public ITbAccidentalFeeDaoS getTbAccidentalFeeDaoS() {
		return tbAccidentalFeeDaoS;
	}

	public void setTbAccidentalFeeDaoS(ITbAccidentalFeeDaoS tbAccidentalFeeDaoS) {
		this.tbAccidentalFeeDaoS = tbAccidentalFeeDaoS;
	}
	...
	public ITbAccidentalFee_CarDaoS getTbAccidentalFee_CarDaoS() {
		return tbAccidentalFee_CarDaoS;
	}

	public void setTbAccidentalFee_CarDaoS(
			ITbAccidentalFee_CarDaoS tbAccidentalFeeCarDaoS) {
		tbAccidentalFee_CarDaoS = tbAccidentalFeeCarDaoS;
	}
