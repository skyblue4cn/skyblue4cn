...
public class TbPartmentServ implements ITbPartmentServ {
	 ...
	 * 根据输入的名称查询部门信息
	 * (non-Javadoc)
	 * @see cn.insurance.service.ITbPartmentServ#getPartmentByName(cn.insurance.model.PageBean, cn.insurance.model.TbPartment)
	 */
	public PageBean getPartmentByName(PageBean pageBean , String words, Integer companyId){
		return null ;
	...
	public int deletePartmentById(Integer id) {
		tbAccidentalFeeDao.deleteByPartmentId(id) ;
		tbAdjustFeeDao.deleteByPartmentId(id) ;
		tbAccountDao.deleteByPartmentId(id) ;
