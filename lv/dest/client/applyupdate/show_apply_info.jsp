	...
	<table border="1" cellpadding="0" cellspacing="0" width="70%" class="table text9" >
		...
		<tr>
			<td colspan="2" valign="top">
				&nbsp;&nbsp;&nbsp;&nbsp;本保险人现向你公司申请批改
					<a href="c_getBillInfoToPrint.action?limitId=<ww:property value="tbApply.intBillId"/>&limitKey=<ww:property value="@cn.insurance.action.SupportAction@getEencodeIdKey('ckbill',tbApply.intBillId)"/>&limitType=ckbill" target="_blank"><ww:property value="tbApply.strBillNumber"/></a>
