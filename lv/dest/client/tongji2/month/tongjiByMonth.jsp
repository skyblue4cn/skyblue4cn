...
<br>
<div style="text-align:center;font:16px;font-weight:bold;"><ww:property value="ams.year"/>年数据统计</div>
<br>
...
<table border="1" cellpadding="0" cellspacing="0" width="95%" class="table" style="text-align:center;line-height:30px;" >
	...
	<tr>
		<td>
			<a href="c_tongJiByDate.action?year=<ww:property value="year"/>&month=<ww:property value="month"/>" >
