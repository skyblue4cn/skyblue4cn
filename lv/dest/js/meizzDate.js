...
document.onclick=closel ;
function closel() //任意点击时关闭该控件	//ie6的情况可以由下面的切换焦点处理代替
{ 
  with(window.event)
...
document.onkeyup = closell ;
function closell()		//按Esc键关闭，切换焦点关闭
  {
...
function closeLayer()               //这个层的关闭
  {
  	if(document.all.meizzDateLayer.style != null){
