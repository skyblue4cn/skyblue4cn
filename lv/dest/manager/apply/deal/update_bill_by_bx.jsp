...
<form method="post" name="form1" enctype="multipart/form-data">
	<input type="hidden" name="tbBill.id" value="<ww:property value="tbBill.id"/>"/>
      ...
      <td colspan="2"><div class="tabcont2"><span class="lvtitle"><ww:property value="tbBill.strBillName"/></span></div>
        <div class="tabcont2">
          <table width="90%" border="0" cellspacing="0" cellpadding="0" class="table">
			...
			<tr>
              <td width="10%">保单种类</td>
              <td width="40%">
              <ww:radio name="tbBill.intKindId" list="#{1:'责任险',2:'意外险'}" value="%{tbBill.intKindId}" theme="simple"></ww:radio>
              <td width="10%">旅游类型</td>
              <td width="40%">
              <ww:radio name="tbBill.intTravelProperty" list="#{0:'国内旅游',1:'出入境旅游'}" value="%{tbBill.intTravelProperty}" theme="simple"></ww:radio>
            </tr>
          </table>
        </div>
        <div class="tabcont2">
          <table width="90%" border="0" cellpadding="0" cellspacing="0" class="table">
            <tr>
              ...
              <td colspan="3"><ww:textfield name="tbBill.strCompanyName" theme="simple" readonly="true" cssClass="inputbox1" size="38"/></td>
              <td width="10%">保单号</td>
              <td width="28%"><ww:textfield name="tbBill.strBillNumber" theme="simple" readonly="true" cssClass="inputbox1" size="38"/></td>
            </tr>
            <tr>
              <td>部门名称（盖章）</td>
        ...
        <div class="tabcont2" style="padding:16px 0;">
          <table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              	<td><input type="button" class="inputbutton" id="button4" onclick="updateBillByBx()" value="提交更改" /></td>
              	<td><input type="button" class="inputbutton" id="button3" onclick="openAWindow('toReturnSureBillByBx.action?id=<ww:property value="tbBill.id"/>')" value="退回作废"/></td>
