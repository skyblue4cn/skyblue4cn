		...
		<tr valign="top">
			<td width="10%" style="text-align:center">
				 <div class="tabcont">
			    	...
			    	<br>
			    	<br/>
			    	<input id="button1" class="inputbutton" type="button" onclick="location.href='getAllNotReplyOfApplyForBx.action'" value="未处理申请" /><br/><br/>
					<input id="button2" class="inputbutton3" type="button" onclick="location.href='getAllHasReplyOfApplyForBx.action'" value="已处理申请" /><br/><br/>
			...
			<td>
				<div id="contbar">
				     <div class="pind">
		    		<img src="images/yclsq.gif" width="140" height="55" />
			        <div class="tsinfo">
			        <br/>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="table">
							<tr>
								...
								<th scope="col" width="10%">经手人</th>
								<th scope="col" width="10%">回复时间</th>
								<th scope="col" width="6%">详情</th>
							</tr>
							<ww:iterator value="pageBean.dataList" status="index">
								<tr>
									<td align="center"><ww:property value="pageBean.curFromIndex + #index.index"/></td>
									<td><a href="getBillInfoToPrint.action?id=<ww:property value="intBillId"/>" target="_blank">
									...
									<td><ww:date name="dteReplyTime" format="yy-MM-dd"/></td>
									<td align="center">
										<a href="getApplyUpdateInfo.action?tbApply.id=<ww:property value="id"/>" target="_blank">
