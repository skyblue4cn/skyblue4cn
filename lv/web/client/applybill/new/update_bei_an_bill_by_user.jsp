      ...
      <td colspan="2"><div class="tabcont2"><span class="lvtitle"><ww:property value="tbBill.strBillName"/></span></div>
        ...
        <div class="tabcont2">
          <table width="90%" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
              ...
              <td width="9%">导游</td>
              <td width="15%"><ww:textfield name="tbBill.strDragoman" theme="simple" cssClass="inputbox1" readonly="true"/></td>
              <td>团队号<font color="red">*</font></td>
              <td><ww:textfield id="team" name="tbBill.strTeamNumber" theme="simple" cssClass="inputbox1" readonly="true"/></td>
            </tr>
            <tr>
              <td>电话<font color="red">*</font></td>
              <td><ww:textfield id="phone" name="tbBill.strPhoneNumber" theme="simple" cssClass="inputbox1" readonly="true"/></td>
              <td>传真</td>
              <td><ww:textfield name="tbBill.strFax" theme="simple" cssClass="inputbox1" readonly="true"/></td>
              <td>旅游线路<font color="red">*</font></td>
              <td><ww:textfield id="rold" name="tbBill.strTravelRold" theme="simple" cssClass="inputbox1" readonly="true"/></td>
            </tr>
            <tr>
              <td>组团形式</td>
              <td colspan="3">
            ...
            <tr>
              <td>旅游形式</td>
              <td colspan="3">
              	<ww:radio name="tbBill.intTravelType" list="#{0:'常规',1:'自驾车',2:'自由人'}" value="%{tbBill.intTravelType}" theme="simple" onchange="getBillPrice()" disabled="true"/>
              </td>
              <td colspan="2">自<input type="text" id="startTime" name="tbBill.dteStartTime" value="<ww:date name="tbBill.dteStartTime" format="yyyy-MM-dd"/>"  class="inputbox1" readonly="true" /></td>
            </tr>
            <tr>
              <td>高风险旅游项目</td>
              <td colspan="3">
              ...
              <td colspan="2">至<input type="text" id="endTime" name="tbBill.dteEndTime" value="<ww:date name="tbBill.dteEndTime" format="yyyy-MM-dd"/>" class="inputbox1"  readonly="true" /></td>
            </tr>
          </table>
        </div>
        <div class="tabcont2">
            ...
            <ww:else>
            	<ww:if test="tbBill.intTravelProperty==0">
		           		<tr>
		            		...
		            		<td>内宾(万元/人)</td>
		            		<td colspan="3"><ww:radio name="tbBill.intNBFeeType" list="#{0:'10/意外死亡伤残+2/意外医疗+0.5/丧葬',1:'20/意外死亡伤残+2/意外医疗+0.5/丧葬'}"  value="%{tbBill.intNBFeeType}" theme="simple" onchange="getBillPrice()" disabled="true"/></td>
		            	</tr>
		            	<tr>
		            		<td>外宾(万元/人)</td>
		            		<td colspan="3"><ww:radio name="tbBill.intWBFeeType" list="#{0:'30/意外死亡伤残+3/意外医疗+2/丧葬',1:'40/意外死亡伤残+3/意外医疗+2/丧葬'}" value="%{tbBill.intWBFeeType}" theme="simple" onchange="getBillPrice()" disabled="true"/></td>
		            	</tr>
	           	</ww:if>
	           	<ww:else>
	           		<tr>
	            		<td rowspan="3">保险金额</td>
	            		<td>内宾(万元/人)</td>
	            		<td colspan="3"><ww:radio name="tbBill.intNBFeeType" list="#{2:'30/意外死亡伤残+3/意外医疗+2/丧葬',3:'40/意外死亡伤残+3/意外医疗+2/丧葬'}" value="%{tbBill.intNBFeeType}" theme="simple" onchange="getBillPrice()" disabled="true"/></td>
	            	</tr>
	            	<tr>
	            		<td>外宾(万元/人)</td>
	            		<td colspan="3"><ww:radio name="tbBill.intWBFeeType" list="#{0:'30/意外死亡伤残+3/意外医疗+2/丧葬',1:'40/意外死亡伤残+3/意外医疗+2/丧葬'}" value="%{tbBill.intWBFeeType}" theme="disabled="true"" onchange="getBillPrice()" disabled="true"/></td>
	            	</tr>
	           	</ww:else>
	           	<tr>	
            		<td>未成年人(万元/人)</td>
        ...
        <div class="tabcont2">
	       <table border="0" cellpadding="0" cellspacing="0" width="100%">
	       	<tr>
	       		<td width="15%"> 
		       		<ww:if test="tbBill.intIsAddTraveler==0">
		        		<input type="radio" id="travelerRadio1" name="tbBill.intIsAddTraveler" value="0" checked="checked" />
		        	</ww:if>
			        <ww:else>
	       		...
	       		<td width="85%" valign="bottom">
	       			<span style="color:red;" id="messageDiv" >
	       				重要说明：请务必在旅游起始时间当天15：00点前添加所有旅客明细，否则保单无效,保险公司不承担责任！
	       			&nbsp; </span>
	        	</td>
	       	</tr>
	       	<tr>
	       		<td>
		       		<ww:if test="tbBill.intIsAddTraveler==1">
		        		<input type="radio" id="travelerRadio2" name="tbBill.intIsAddTraveler" value="1" checked="checked"  />
		        	</ww:if>
			        <ww:else>
			        	<input type="radio" id="travelerRadio2" name="tbBill.intIsAddTraveler" value="1"  />
			        </ww:else>
		       		添加旅客明细
	       		</td>
	       		<td>
        ...
        <div class="tabcont2" style="padding:16px 0;">
          <table width="90%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><input type="button" class="inputbutton" id="button4" onclick="updateBeiAnBill()" value="提交" /></td>
              <td><input type="button" class="inputbutton" id="button" value="删除" onclick="location.href='deleteBillByUser.action?id=<ww:property value="tbBill.id"/>'" /></td>
