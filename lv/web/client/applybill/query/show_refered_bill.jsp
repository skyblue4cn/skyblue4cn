  ...
  <tr valign="top">
       <td width="15%" valign="top" align="center" style="background:#ededed;"  height="540px">
	     <div class="tabcont">
	    	...
	    	<input id="button1" class="inputbutton3" type="button" onclick="location.href='c_showReferBillList.action'" value="待审核保单" /><br/><br/>
    ...
    <div class="tabcont" id="billContent">
    	<br>
      	<div style="text-align: center;font-weight: bold;font-size: 16px;">待审核保单</div>
      	<br>
		 <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table">
		    ...
		    <ww:iterator value="pageBean.dataList" status="index">
				<tr <ww:if test="#index.index%2==0">  bgcolor="#ededed" </ww:if>>
					...
					<td align="center">
						<a href="c_toUpdateBillByUser.action?limitId=<ww:property value="id"/>&limitKey=<ww:property value="@cn.insurance.action.SupportAction@getEencodeIdKey('update',id)"/>&limitType=update" target="_blank">
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left"><li>说明：待审核保单是指保险公司还没有受理的保单，用户在保险公司还没有受理前，保单可以修改！</li></td>
			</tr>
		</table>
  	</td>
  </tr>
