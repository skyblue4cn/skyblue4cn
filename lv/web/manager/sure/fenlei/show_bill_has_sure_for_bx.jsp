		...
		<tr valign="top">
			<td width="10%" style="text-align:center">
				 <div class="tabcont">
					...
					<input id="button3" class="inputbutton3" type="button" onclick="location.href='getBillForBxHasSure.action'" value="已确认保单" /><br/><br/>
			...
			<td width="90%">
				<div id="contbar">
				     <div class="pind">
		    		<img src="images/yqd.gif" width="140" height="55"  />
			        <div class="tsinfo">
			        <br/>
