...
<br>
<div class="text1" style="line-height:30px;"><ww:property value="tbPartment.company.strPartmentName"/>--<ww:property value="tbPartment.strPartmentName"/><br>预存帐户支付记录</div>
<br/>
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="table">
        <tr>
          <th scope="col" width="10%">序号</th>
          <th scope="col" width="15%">时间</th>
          <th scope="col" width="15%">支付金额(元)</th>
          <th scope="col" width="15%">帐户余额（元）</th>
          <th scope="col" width="15%">经办人</th>
          <th scope="col" width="30%">说明</th>
        </tr>
     <ww:iterator value="pageBean.dataList" status="index">
			<tr  <ww:if test="#index.index%2!=0">   bgcolor="#ededed"	</ww:if> style="text-align:center;">
			...
			<td align="left"><ww:property value="strDesc"/></td>
		</tr>
	</ww:iterator>
</table>
<br>
