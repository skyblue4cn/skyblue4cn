...
<br>
<div style="text-align:center;font:16px;font-weight:bold;"><ww:property value="year"/>年数据统计</div>
<a href="file:///c://按年导出的所有旅行社的数据.xls">下载Excel版本(右击>>目标另存为)</a>
<br>
...
<table border="1" cellpadding="0" cellspacing="0" width="95%" class="table" style="text-align:center;line-height:30px;" >
	...
	<ww:iterator value="allCompanyYearStatList" >
	<tr>
		<td>
			<a href="adminTongJi.action?companyId=<ww:property value="company.id"/>&year=<ww:property value="year"/>">
				<ww:property value="company.strPartmentName"/>
			</a>
		</td>
		<td>
